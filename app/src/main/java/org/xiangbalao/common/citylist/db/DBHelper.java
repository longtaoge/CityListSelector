package org.xiangbalao.common.citylist.db;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/org.xiangbalao.baidu/databases/";
    /*
...
//	private static String ASSETS_NAME = "meituan_cities.db";
    ...
    public DBHelper(Context context) {
      ...
      //  this(context, String.valueOf(context.getDatabasePath(DB_NAME)));
